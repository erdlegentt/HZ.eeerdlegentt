...
while 1:
    system("cls||clear")
    print("""{}
    ERDLEGENTT SMS BOMBER HOŞGELDİN YAVVRUMMMM İCERİSİ SAMPİONLAR LİGİ
    
H Z E R D L E G E N T

  insta=erdlegentt00
  
  ABARTMADAN SAKİNCE KULLAN PLS 
  
    Sms: {}           {}by {}@ERDLEGENTT\n  
    """.format(Fore.LIGHTCYAN_EX, len(servisler_sms), Style.RESET_ALL, Fore.LIGHTRED_EX))
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- normal insan gibi (stabil)\n\n 2- annesini hoplatmak istiyorsan (opsiynal)\n\n 3-yeterince bombaladıysan çıkış yeri bebegim\n\n" + Fore.LIGHTYELLOW_EX + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "YANLIŞ YAPTIN YAVRUM. Tekrar deneyiniz.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "yavrum Telefon numarasını başında '+90' olmadan yaz (Birden çoksa 'enter' tuşuna bas): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
            print(Fore.LIGHTYELLOW_EX + "yavrum Telefon numaralarının kayıtlı olduğu dosyanın dizinini yaz: "+ Fore.LIGHTGREEN_EX, end="")
            dizin = input()
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "yavrum Hatalı dosya dizini. Tekrar deneyiniz.")
                sleep(3)
                continue
        else:
            try:
                ...
                sonsuz = "(ebesi sikilene kadar yani sonuz ise 'enter' tuşuna basınız)"  
            except ValueError:
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "yavrum Hatalı telefon numarası. Tekrar deneyiniz.") 
                sleep(3)
                continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "yavrum Mail adresi (Bilmiyorsanız 'enter' tuşuna basın  (bunuda bilme zaten aw): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
            if ("@" not in mail or ".com" not in mail) and mail != "":
                raise
        except:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "yavrum Hatalı mail adresi. Tekrar deneyiniz.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "yavrum Hatalı giriş yaptın. Tekrar deneyiniz.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "yavrum Kaç saniye aralıkla göndermek istiyorsun (1) yap abartma aw : "+ Fore.LIGHTGREEN_EX, end="")
            aralik = int(input())
        except ValueError:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "yavrum Hatalı giriş yaptın. Tekrar deneyiniz.") 
        ...
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "yavrum Telefon numarasını başında '+90' olmadan yaz: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
            ...
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "yavrum Hatalı telefon numarası dügün gir. Tekrar deneyiniz.") 
            sleep(3)
            continue
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "yavrum Mail adresi (Bilmiyorsan 'enter' tuşuna bas): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
            if ("@" not in mail or ".com" not in mail) and mail != "":
                raise
        except:
            system("cls||clear")
            print(Fore.LIGHTRED_EX + "yavrum Hatalı mail adresi. Tekrar dene.") 
            sleep(3)
            continue
        system("cls||clear")
